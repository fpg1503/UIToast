#
#  Be sure to run `pod spec lint UIToast.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/fpg1503/UIToast"
  ...
  s.source       = { :git => "https://github.com/fpg1503/UIToast.git", :tag => "v0.0.3" }
